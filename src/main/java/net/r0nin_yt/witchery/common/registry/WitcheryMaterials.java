...
public class WitcheryMaterials {
	public static final ArmorMaterial HEDGEWITCH_ARMOR = new ArmorMaterial() {
		...
		public Ingredient getRepairIngredient() {
			return Ingredient.ofItems(WitcheryBlocks.HEDGEWITCH_WOOL);
		}
	...
	public static final ArmorMaterial ALCHEMIST_ARMOR = new ArmorMaterial() {
		...
		@Override
		public Ingredient getRepairIngredient() {
			return Ingredient.ofItems(WitcheryBlocks.ALCHEMIST_WOOL);
		}
	...
	public static final ArmorMaterial BESMIRCHED_ARMOR = new ArmorMaterial() {
		...
		@Override
		public Ingredient getRepairIngredient() {
			return Ingredient.ofItems(WitcheryBlocks.BESMIRCHED_WOOL);
		}
	...
	public static final ToolMaterial SILVER_TOOL = new ToolMaterial() {
		...
		@Override
		public Ingredient getRepairIngredient() {
			return Ingredient.ofItems(WitcheryItems.SILVER_INGOT);
		}
	};
}
