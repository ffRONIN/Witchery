...
public class WitcheryScaleTypes {
	//public static final ScaleModifier MODIFY_WIDTH_MODIFIER = register(ScaleRegistries.SCALE_MODIFIERS, "modify_width", new TypedScaleModifier(() -> WitcheryScaleTypes.MODIFY_WIDTH_TYPE));
	//public static final ScaleModifier MODIFY_HEIGHT_MODIFIER = register(ScaleRegistries.SCALE_MODIFIERS, "modify_height", new TypedScaleModifier(() -> WitcheryScaleTypes.MODIFY_HEIGHT_TYPE));
...
//		return ScaleRegistries.register(registry, new Identifier(Witchery.MOD_ID, name), entry);
//	}
